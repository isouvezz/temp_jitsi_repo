...
const OverflowMenuButton = ({
    ...
    const groupsJSX = buttons.map((buttonGroup: any, index: number) => (
        <ContextMenuItemGroup key={`group-${buttonGroup[0].group}-${index}`}>
            ...
            <div className="toolbox-button-wth-dialog context-menu">
                <>
                    ...
                    <JitsiPortal>
                        ...
                        {showReactionsMenu && (
                            <div className="reactions-animations-overflow-container">
    ...
    return (
        <div className="toolbox-button-wth-dialog context-menu">
            <Popover
                ...
                visible={isOpen}
            >
                <OverflowToggleButton isMenuButton={true} isOpen={isOpen} onKeyDown={onEscClick} />
            </Popover>
            {showReactionsMenu && (
