...
const Tabs = ({ accessibilityLabel, className, onChange, selected, tabs }: ITabProps) => {
    ...
    return (
        <div aria-label={accessibilityLabel} className={cx(classes.container, className)} role="tablist">
            {tabs.map((tab, index) => (
                <button
