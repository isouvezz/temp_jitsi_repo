...
const DeepLinkingMobilePage: React.FC<WithTranslation> = ({ t }) => {
    ...
    const generateDownloadURL = useCallback(() => {
        const { downloadLink, dynamicLink, appScheme } = (deeplinkingCfg?.[
            Platform.OS as keyof typeof deeplinkingCfg
        ...
        )}&apn=${apn}&ibi=${ibi}&isi=${isi}&ius=${appScheme}&efr=1`;
    }, [deeplinkingCfg]);
    ...
    return (
        <div className={styles.container}>
            <div className={styles.contentPane}>
                {!hideLogo && (
                    <img alt={t("welcomepage.logo.logoDeepLinking")} src="images/logo-deep-linking-mobile.png" />
                )}
