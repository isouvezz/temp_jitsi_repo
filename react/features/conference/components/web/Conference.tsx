...
import { getJwtExtra, isWithinCourseTime, getCourseId } from "../../../base/jwt/functions";
...
import CourseTimeDialog from "./CourseTimeDialog.web";
...
interface IProps extends AbstractProps, WithTranslation {
    ...
    /**
     * Course time information from JWT.
     */
    _courseTimeInfo?: {
        start_date?: string;
        end_date?: string;
    ...
    /**
     * Whether current time is within course time.
     */
    _isWithinCourseTime: boolean;

    /**
     * Course ID for redirect.
     */
    _courseId?: string;
...
function _mapStateToProps(state: IReduxState) {
    ...
    return {
        ...
        _courseTimeInfo: getJwtExtra(state),
        _isWithinCourseTime: isWithinCourseTime(state),
        _courseId: getCourseId(state),
    };
}
